...

{
    ...
    public void generate(int number) throws IOException {
        ...
        for (int i=0;i<number;i++){
            System.out.println("------------");
            System.out.println("Р’РІРµРґРёС‚Рµ РЅР°Р·РІР°РЅРёРµ С‚РѕРІР°СЂР° в„– " + (i+1));
            String name =reader.readLine();
            System.out.println("------------");
            System.out.println("Р’РІРµРґРёС‚Рµ С†РµРЅСѓ С‚РѕРІР°СЂР° в„– " + (i+1));
            long price = Long.parseLong(reader.readLine());
            System.out.println("------------");
            System.out.println("Р’РІРµРґРёС‚Рµ РѕРїРёСЃР°РЅРёРµ С‚РѕРІР°СЂР° в„– " + (i+1));
