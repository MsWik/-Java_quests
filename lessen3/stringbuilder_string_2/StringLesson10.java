...
public class StringLesson10 {

    public static void main(String[] args) {

        String sytimg = "But I must explain to you how all this mistaken idea " +
        ...
        System.out.println("Число предложений  " + size);
    }
}
